...
<div class="discount-body">
    ...
    <div class="disbtn">
      <button class="bg-primary"><a href="<?php echo URLROOT.'policecar/edit/'.$policecar->id;?>">Edit</a></button>
      <button class="bg-danger"><a href="<?php echo URLROOT.'policecar/delete/'.$policecar->id;?>">Delete</a></button>
    </div>
  </div>
  <?php endforeach; ?>
