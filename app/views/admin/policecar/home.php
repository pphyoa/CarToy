...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'policecar/home'; ?>" method="post" enctype="multipart/form-data">
        <h1>To Add Police Cars</h1>
        ...
        <div class="finalinput">
           <button><a href="<?php echo URLROOT.'policecar/show'; ?>">Show Police Cars</a></button>
