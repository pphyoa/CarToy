...
<div class="discount-body">
    ...
    <div class="disbtn">
      <button class="bg-primary"><a href="<?php echo URLROOT.'buscar/edit/'.$buscar->id;?>">Edit</a></button>
      <button class="bg-danger"><a href="<?php echo URLROOT.'buscar/delete/'.$buscar->id;?>">Delete</a></button>
    </div>
  </div>
  <?php endforeach; ?>
