...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'buscar/home'; ?>" method="post" enctype="multipart/form-data">
        <h1>To Add Bus Cars</h1>
        ...
        <div class="finalinput">
           <button><a href="<?php echo URLROOT.'buscar/show'; ?>">Show Bus Cars</a></button>
