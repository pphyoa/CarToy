...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'jeepcar/edit'; ?>" method="post" enctype="multipart/form-data">
        <h1>Edit Jeep Cars</h1>
        ...
        <input type="submit" name="submit" class="editinput" value="Update Jeepcar">
