...
<div class="discount-body">
    ...
    <div class="disbtn">
      <button class="bg-primary"><a href="<?php echo URLROOT.'jeepcar/edit/'.$jeepcar->id;?>">Edit</a></button>
      <button class="bg-danger"><a href="<?php echo URLROOT.'jeepcar/delete/'.$jeepcar->id;?>">Delete</a></button>
    </div>
  </div>
  <?php endforeach; ?>
