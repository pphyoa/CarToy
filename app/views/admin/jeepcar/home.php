...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'jeepcar/home'; ?>" method="post" enctype="multipart/form-data">
        <h1>To Add Jeep Cars</h1>
        ...
        <div class="finalinput">
           <button><a href="<?php echo URLROOT.'jeepcar/show'; ?>">Show Jeep Cars</a></button>
