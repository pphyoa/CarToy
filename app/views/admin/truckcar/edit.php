...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'truckcar/edit'; ?>" method="post" enctype="multipart/form-data">
        <h1>Edit Truck Cars</h1>
        ...
        <input type="submit" name="submit" class="editinput" value="Update Truckcar">
