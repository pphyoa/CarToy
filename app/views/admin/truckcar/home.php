...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'truckcar/home'; ?>" method="post" enctype="multipart/form-data">
        <h1>To Add Truck Cars</h1>
        ...
        <div class="finalinput">
           <button><a href="<?php echo URLROOT.'truckcar/show'; ?>">Show Truck Cars</a></button>
