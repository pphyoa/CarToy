...
<div class="discount-body">
    ...
    <div class="disbtn">
      <button class="bg-primary"><a href="<?php echo URLROOT.'truckcar/edit/'.$truckcar->id;?>">Edit</a></button>
      <button class="bg-danger"><a href="<?php echo URLROOT.'truckcar/delete/'.$truckcar->id;?>">Delete</a></button>
    </div>
  </div>
  <?php endforeach; ?>
