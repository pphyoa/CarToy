...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'supercar/home'; ?>" method="post" enctype="multipart/form-data">
        <h1>To Add Super Cars</h1>
        ...
        <div class="finalinput">
           <button><a href="<?php echo URLROOT.'supercar/show'; ?>">Show Super Cars</a></button>
