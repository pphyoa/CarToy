...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'supercar/edit'; ?>" method="post" enctype="multipart/form-data">
        <h1>Edit Super Cars</h1>
        ...
        <input type="submit" name="submit" class="editinput" value="Update Supercar">
