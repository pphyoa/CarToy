...
<div class="discount-body">
    ...
    <div class="disbtn">
      <button class="bg-primary"><a href="<?php echo URLROOT.'supercar/edit/'.$supercar->id;?>">Edit</a></button>
      <button class="bg-danger"><a href="<?php echo URLROOT.'supercar/delete/'.$supercar->id;?>">Delete</a></button>
    </div>
  </div>
  <?php endforeach; ?>
