...
<div class="discount-body">
    ...
    <div class="disbtn">
      <button class="bg-primary"><a href="<?php echo URLROOT.'admin/edit/'.$discount->id;?>">Edit</a></button>
      <button class="bg-danger"><a href="<?php echo URLROOT.'admin/delete/'.$discount->id;?>">Delete</a></button>
    </div>
  </div>
  <?php endforeach; ?>
