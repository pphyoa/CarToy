...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'admin/home'; ?>" method="post" enctype="multipart/form-data">
        <h1>Short Time Discount Price</h1>
        ...
        <div class="input-group">
            <input type="text" name="originalprice" class="form-control <?php echo !empty($data['originalprice_err']) ? 'is-invalid' : '';?>" placeholder="Original Price">
            <span class="invalid-feedback"><?php echo !empty($data['originalprice_err']) ? $data['originalprice_err'] : ''; ?></span>
        </div>
        <div class="input-group">
            <input type="text" name="discountprice" class="form-control <?php echo !empty($data['discountprice_err']) ? 'is-invalid' : '';?>" placeholder="Discount Price">
            <span class="invalid-feedback"><?php echo !empty($data['discountprice_err']) ? $data['discountprice_err'] : ''; ?></span>
        </div>
        <div class="input-group">
        ...
        <div class="finalinput">
           <button><a href="<?php echo URLROOT.'admin/show'; ?>">Show detail product</a></button>
