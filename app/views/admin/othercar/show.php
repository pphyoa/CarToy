...
<div class="discount-body">
    ...
    <div class="disbtn">
      <button class="bg-primary"><a href="<?php echo URLROOT.'othercar/edit/'.$othercar->id;?>">Edit</a></button>
      <button class="bg-danger"><a href="<?php echo URLROOT.'othercar/delete/'.$othercar->id;?>">Delete</a></button>
    </div>
  </div>
  <?php endforeach; ?>
