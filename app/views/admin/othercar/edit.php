...
<div class="admin">
  <div class="admin-pannel">
     ...
     <div class="admin-page">
      <form action="<?php echo URLROOT.'othercar/edit'; ?>" method="post" enctype="multipart/form-data">
        <h1>Edit Other Cars</h1>
        ...
        <input type="submit" name="submit" class="editinput" value="Update OtherCar">
